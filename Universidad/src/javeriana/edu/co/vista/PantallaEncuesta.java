 ...
 */
public class PantallaEncuesta extends javax.swing.JFrame implements IAccionesPantalla{
    
    private IControlReportes controlReportes = ControlReportes.getInstance();
    private static PantallaEncuesta instance = null;
    
    public PantallaEncuesta() {
    }

    public static PantallaEncuesta getInstance() {
        if (instance == null) {
            instance = new PantallaEncuesta();
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        PantallaEncuesta.getInstance().setVisible(false);
